...
const Sparring = () => {
   ...
   const cancelRequest = () => {
    ...
    return(
        <div className="container-f sparring-search-body  ">

        <div className='text-center container-fluid font-mono fs-1  bg-gradient '>
            <div className='text-white fs-1'>Pugilist Express</div>
        </div>
        
        <div className='sparring-container mx-auto'>
            <div className='bout-title text-start font-mono fw-bolder'>Find a Sparring Partner</div>
                ...
                { fightRequest && 
                    <div className='container fight-request-body mx-auto'>
                        <div className='fight-request-container'>
                            <div className='title'>Send Sparring Request</div> 
                            <form>
